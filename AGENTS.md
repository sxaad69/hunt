...
- 📄 **Paper 2026-09-12 smart gate**: 187 SL / 24h, 177 no smart signal. Tracked buy is now **required** (`no_smart_wallet`); dust no longer boostable (ZEC 1 SOL). Live frozen.
